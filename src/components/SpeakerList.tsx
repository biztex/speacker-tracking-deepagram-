...
export const SpeakerList: React.FC<SpeakerListProps> = ({
  ...
  return (
    <div className="rounded-xl bg-[var(--color-bg-secondary)] p-6 border border-[var(--color-border)]">
            ...
            >
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center space-x-3">
                  <div className={`h-8 w-8 rounded-full flex items-center justify-center text-white text-sm font-bold speaker-${speaker.id}-bg`}>
                    {speaker.id}
                  </div>
